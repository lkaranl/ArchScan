...
class Dados(RawConfigParser):
    ...
    def Gravar_Dados(self):
        ...
        self.set("Porta","Open",ports_ident['open']) 
        self.set("Porta","Close",ports_ident['closed']) 
        self.set("Porta","Filte",ports_ident['filtered'])
        self.set("Porta","Opfil",ports_ident['open|filtered'])
        FLconf = open(Arq,"a")
        self.write(FLconf)
        FLconf.close()
